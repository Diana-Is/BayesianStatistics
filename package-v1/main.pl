...
system("matlab -nodisplay -nodesktop -r \"cd('".$codefolder."'); cell_extract('".$slidefolder."', '".$codefolder."', '".$savefolder."', '".$roi."'); quit;\" >> ".$DataDir."/log.txt");
...
print("********************\n");
system("matlab -nodisplay -nodesktop -r \"cd(['".$WorkingDir."', '/image_border/']); main('"."$DataDir"."'); quit;\" >> ".$DataDir."/log.txt");
print("Well done!\n");
